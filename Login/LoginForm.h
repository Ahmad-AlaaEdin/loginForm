...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(155, 53);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(223, 62);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(223, 126);
			...
			this->label1->Location = System::Drawing::Point(66, 126);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Tahoma", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(66, 68);
			...
			this->ClientSize = System::Drawing::Size(550, 397);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		StreamWriter ^ file = gcnew StreamWriter("check.txt");
		file->Write( name + " " + password + "\r\n");

		file->Close();

		fstream check;
		check.open("check.txt", ios::in | ios::out);
		check >> u1 >> p1;
		check.close();
		...
		string u, p;
		fstream data;
		data.open("users.txt", ios::in | ios::out);
